...
#            return tencode(u"Module \""+mid+u"\" does not exist, Please add it \""+'_'.join(sys_param_array)+u"\" || \""+'_'.join(self.get_string_array)+u"\"  ",SECRET_KEY)
            #return tencode(u"Module \""+mid+u"\" does not exist, Please add it, command is  \""+importstring+u"\" sysdir is \""+sys.path[0]+u"\" \""+AUTO_PLATFORM+u"\"  ",SECRET_KEY)
